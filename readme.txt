...
Use MainPreTest to test a single combination of 3 spaces.
Using Main you can test any combination of spaces, fomatting such as:
A1 B2 C3
The valid spaces lie on a grid from A1 to H4
Valid combinations will output the moves taken
